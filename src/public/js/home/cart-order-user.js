$(document).ready(function () {
    ...
    function fetchProducts() {
        console.log(`fetchProducts with userId: ${userId}`)
        $.ajax({
            url: `/cart/products/${userId}`,
            method: "GET",
            beforeSend: function () {
    ...
    function registerConfirmUpdate() {
        ...
        btnConfirm.on("click", function () {
            ...
            console.log(`registerConfirmUpdate with userId: ${userId}`)
            console.log(data);
            $.ajax({
                url: `/cart/${userId}`,
                method: "POST",
    ...
    function registerRemove() {
        ...
        btnRemove.on("click", function () {
            ...
            console.log(`registerRemove with userId: ${userId}`)
            $.ajax({
                url: `/cart/${userId}`,
                method: "DELETE",
                data: JSON.stringify(data),
